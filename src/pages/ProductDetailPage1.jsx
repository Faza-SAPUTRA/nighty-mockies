    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-4">Dragon Not Found</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <motion.div
              ...
              className="flex items-center justify-center space-x-4 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4"
            >
          ...
          >
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-white">Dragon Story</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-4">
                <h4 className="text-white font-semibold mb-3">Nutrition Facts</h4>
