    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black pt-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-white">Visit Our Dragon Lair</h3>
              </div>
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-6">
              <div>
                ...
                <motion.input
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-white transition-colors duration-200"
              ...
              <div>
                ...
                <motion.textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-white transition-colors duration-200 resize-none"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full bg-white text-black py-4 rounded-xl font-bold text-lg flex items-center justify-center space-x-2 hover:bg-gray-200 transition-colors duration-200"
              >
                <Send size={20} />
        ...
        <motion.div
          ...
          className="mt-20 text-center bg-gradient-to-r from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-12 border border-gray-700"
        >
